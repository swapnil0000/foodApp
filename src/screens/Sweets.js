...
import { combo, fastest, orderData, sweets } from '../utils/common';
...
export default function Sweets() {
    ...
    return (
        ...
        <Typography sx={{fontSize:'30px',fontWeight:'600',fontFamily:'lato',marginLeft:'25px',color:'whitesmoke'}}>Khane Baad Kuch Mitha</Typography>
     ...
     <CartModel  open={openModel} setOpenModel={setOpenModel} name={ele.name} img={ele.img} price={ele.price} value={ele.value} />
         </Grid>
       ))}
     </Grid>
       </Box>
